        ...
        <section id="contacto" className="py-16 md:py-20 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6">
              ...
              <a href="mailto:tukompaprestamo@gmail.com" className="p-6 border rounded-lg hover:shadow-soft transition-smooth text-center">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-primary" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-muted-foreground">tukompaprestamo@gmail.com</p>
              </a>
              
              <a href={`https://wa.me/2348025626573?text=${encodeURIComponent("Hola, necesito información sobre préstamos")}`} target="_blank" rel="noopener noreferrer" className="p-6 border rounded-lg hover:shadow-soft transition-smooth text-center">
